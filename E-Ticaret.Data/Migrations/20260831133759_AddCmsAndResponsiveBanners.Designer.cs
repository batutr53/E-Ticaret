...
namespace E_Ticaret.Data.Migrations
{
    ...
    [Migration("20260831133759_AddCmsAndResponsiveBanners")]
    partial class AddCmsAndResponsiveBanners
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.FooterContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.FooterMobileMenu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.Order", b =>
                {
                    ...
                    b.Property<int?>("DeliveryTimeRangeId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.FooterLink", b =>
                {
                    b.HasOne("E_Ticaret.Core.Entities.FooterSection", "Section")
                        .WithMany("Links")
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.Order", b =>
                {
                    b.HasOne("E_Ticaret.Core.Entities.DeliveryTimeRange", "DeliveryTimeRange")
                        .WithMany()
                        .HasForeignKey("DeliveryTimeRangeId");

                    b.Navigation("DeliveryTimeRange");
                });
