...
namespace E_Ticaret.WEBUI.Areas.Admin.Controllers
{
    ...
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,City,District,OpenAddress,IsActive,IsBillingAddress,IsDeliveryAddress,CreatedDate,AddressGuid,UserId")] Address address)
        {
